(function() {
  var EventEmitter, Getbot, fs, http, makeReadable, path, request, url, util,
  ...
  Getbot = (function(_super) {
            ...
            case 200:
              ...
              try {
                ...
                return fs.open(newFilename, 'w', function(err, fd) {
                  ...
                  return _this.startParts(options, _this.size, 10, _this.download);
                });
              } catch (error) {
    ...
    Getbot.prototype.download = function(options, offset, end) {
      ...
      req.on('data', function(data) {
        ...
        file.write(data);
        _this.emit('data', _this.totalDownloaded, rate);
      });
